...
export default function Testimonials() {
  ...
  function nextTestimonial() {
    if (id === 1) {
      ...
      name.current.innerHTML = 'Parth Makwana'
      img.current.src = "https://randomuser.me/api/portraits/men/3.jpg"
      taarif.current.innerHTML = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo accusantium eius doloremque assumenda pariatur? Voluptatem consectetur iusto fugiat."
      id = 3
    }
    else if (id === 3) {
    ...
    <section className="cr">
      ...
      <div className="testimonial-section center">
        <div className="testimonial" id="t-1">
          <i onClick={()=>prevTestimonial()} className="fa-solid fa-chevron-left"></i>
